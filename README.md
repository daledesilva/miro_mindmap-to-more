# Mindmap to More
A Miro plugin. An experiment with converting Miro mindmap nodes into laid out shapes.

### Updates

2022: This plugin broke after Miro API changes removed the ability to target mindmap nodes.
